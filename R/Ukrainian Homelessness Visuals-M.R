----#Mathura Graphs Updates#----


##Selecting Data for Analysis only##
...
OnlyN |>
  ...
  labs(title = 'Ukrainian Households at Risk or Experiencing Homelessness', 
       x = 'June 3, 2022 - April 21, 2023', 
       y = 'Number of Households', 
       caption = 'BRC Analysis of DLUHC Data as of April 2023. Data collected since 24 Feb 2022')

ggsave("images/total homelessness.png", width = 250, height = 150, units = "mm")
...
theme_classic() +
labs(title = 'Month-by-Month % Change in Homelessness Among Ukrainian Households Arrived in the UK', x = 'June 3 2022 - April 21 2023', y = 'Percentage', caption = 'Data collected since 24 Feb 2022')
...
Kidsinhouse |>
  ...
  labs(title = 'Ukrainian Households with Dependent Children at Risk or Experiencing Homelessness', 
       x = 'June 3, 2022 - April 21, 2023', 
       y = 'Number of Households', 
       caption = 'BRC Analysis of DLUHC Data as of April 2023. Data collected from 24 Feb 2022')
