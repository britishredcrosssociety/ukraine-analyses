...
homelessness_total <- 
  ...
  relocate(Date) |> 
  mutate(Date_text = factor(Date_text, levels = c("3 June", "1 July", "29 July", "26 August", "23 September", "21 October", "18 November", "27 January", "24 February", "24 March", "21 April")))
