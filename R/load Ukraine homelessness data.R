...
homelessness_total <- 
  ...
  relocate(Date) |> 
  mutate(Date_text = factor(Date_text, levels = c("3 June", "1 July", "29 July", "26 August", "23 September", "21 October")))
...
homelessness_trends <- 
  ...
  mutate(
    total_delta = total_21oct - total_3jun,
    percent_delta = percent_21oct - percent_3jun,
    temp_delta = temp_21oct - temp_3jun,
    temp_percent_delta = temp_percent_21oct - temp_percent_3jun
  )
